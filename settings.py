...
topics = {
    "Delivery": ['出貨', '到貨', '配送', '送貨', '寄件', '速度', '出貨速度', '宅配', '物流'],
    "Package": ['包裝', '撒了出來', '灑出來', '破裂', '破損', '聯名', '可愛', '設計', '瓶身', '合作', '包材', '紙盒', '紙袋', '盒子', '壓頭'],
    "Price": ['價格', '價錢', '划算', '優惠', '買一送一', '便宜', '特價', '回饋', '折價券', '活動', '組合價'],
    "Giveaway": ['贈品', '小樣', '試用品', '滿額禮', '送東西', '禮物'],
    "Efficacy": ['吸收', '效果', '質地', '品質', '好用', '有用', '有效', '味道', '香味', '無香', '清爽', '厚重' '不油', '舒服', '乾淨', '保濕度', '很保濕', '舒緩', '泛紅', '穩定',
                 '滋潤', '不乾', '不會乾', '不會很乾', '乾澀', '乾癢', '乾燥', '黏膩', "粘膩", '刺激', '細緻', '滑嫩', '顆粒', '平滑', '光滑', '緊繃', '延展', '推勻', '保濕', '超級保濕',
                 '痘痘', '粉刺', '毛孔', '黑頭', '紋路', '細紋', '過敏', '脫皮', '乾裂', '龜裂', '改善', '痘疤', '淡疤', '淡斑',
                 '浮粉', '貼妝', '服貼', '服帖', '斑駁', '脫妝', '持久', '顯白', '顯黃', '顯黑', '暗沉', '暗沈', '持色', '掉妝', '顏色', '妝感',
                 '蓬鬆', '豐盈', '柔順', '毛躁', '脫髮', '生髮', '扁塌', '出油']
}
